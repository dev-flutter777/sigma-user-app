              ...
              child: Padding(
                ...
                child: Column(children: [
                  Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    IconButton(
                      tooltip: getTranslated('delete', context),
                      onPressed: () =>
                          cartProvider.removeFromCartAPI(cartModel?.id, index),
                  ...
                  MinOrderQuantityWidget(
                      minOrderQty: cartModel?.productInfo?.minimumOrderQty ?? 1,
                      currentQty: cartModel?.quantity),
                  const SizedBox(height: 4),
                  Align(
                    alignment: AlignmentDirectional.centerEnd,
                    child: _CartQuantityControlsWidget(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: Theme.of(context).primaryColor.withValues(alpha: .16)),
      ),
      child: Padding(
          ...
          children: [
            cartModel?.increment ?? false
                ...
                : CartQuantityButton(
                    ...
                    digitalProduct:
                        cartModel!.productType == "digital" ? true : false,
                  ),
            Padding(
              ...
              child: Text(
                ...
                style: textMedium.copyWith(
                  ...
                  color: (cartModel!.shop != null &&
                          cartModel?.shop?.vacationStatus != null &&
                          cartModel?.shop?.temporaryClose != null &&
