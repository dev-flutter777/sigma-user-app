          ...
          return Form(
            ...
            child: Column(children: [
              ...
              RequiredRegistrationPolicyLinks(
                policies: authProvider.requiredRegistrationPolicies,
              ),
                    ...
                    child: CustomButton(
                      ...
                      onTap: (authProvider.isAcceptTerms &&
                          ...
                          ? () {
                              ...
                              String phoneNumber =
                                  EgyptPhoneHelper.toInternational(
                              ...
                              if (signUpFormKey.currentState?.validate() ??
                                ...
                                register.policyVersionIds = authProvider
                                    .requiredRegistrationPolicies
                                    .map((policy) =>
                                        int.tryParse(policy['id'].toString()) ??
                                        0)
                                    .where((id) => id > 0)
                                    .toList();
