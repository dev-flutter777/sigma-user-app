...
class _AddressListScreenState extends State<AddressListScreen> {
  ...
  void _onScroll() {
    if (_scrollController.position.atEdge) {
      isScrolledToEnd = _scrollController.position.pixels ==
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: isScrolledToEnd
          ? null
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return AddressItemWidget(
                              locationProvider: locationProvider, index: index);
                        },
                      ),
                    )
...
class AddressItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
          ...
          child:
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: <InlineSpan>[
                    TextSpan(
                        text:
                            '${locationProvider.addressList![index].addressType?.toUpperCase()} ',
                    ...
                    TextSpan(
                        text:
                            '(${(locationProvider.addressList?[index].isBilling ?? false) ? getTranslated('billing_address', context) : getTranslated('shipping_address', context)})',
                ...
                itemBuilder: (BuildContext context) => [
                  PopupMenuItem<String>(
                    ...
                    child: Padding(
                      ...
                      child: Row(children: [
                        const CustomAssetImageWidget(Images.edit,
                            height: Dimensions.homePagePadding,
                            width: Dimensions.homePagePadding),
                  ...
                  PopupMenuItem<String>(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsets.all(Dimensions.paddingSizeSmall),
                      child: Row(children: [
                        const CustomAssetImageWidget(Images.delete,
                            height: Dimensions.homePagePadding,
                            width: Dimensions.homePagePadding),
                        const SizedBox(width: Dimensions.paddingSizeEight),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Flexible(
                ...
                TextSpan(
                    text: locationProvider.addressList?[index].city ?? "",
                    style: textRegular.copyWith(
                      fontSize: Dimensions.fontSizeSmall,
                      color: Theme.of(context).textTheme.bodyLarge?.color,
                    )),
              ...
              Flexible(
                ...
                TextSpan(
                    text: locationProvider.addressList?[index].zip ?? "",
                    style: textRegular.copyWith(
                      fontSize: Dimensions.fontSizeSmall,
                      color: Theme.of(context).textTheme.bodyLarge?.color,
                    )),
      ...
      if ((locationProvider.addressList?.length ?? 0) <= 5 &&
          index == (locationProvider.addressList?.length ?? 0) - 1)
