...
class AddressService implements AddressServiceInterface {
  ...
  Future<ApiResponseModel> update(
      Map<String, dynamic> addressModel, int id) async {
    ApiResponseModel apiResponse =
        await addressRepoInterface.update(addressModel, id);
    return apiResponse;
  }
  ...
  Future getDeliveryRestrictedCountryBySearch(String country) async {
    ApiResponseModel response = await addressRepoInterface
        .getDeliveryRestrictedCountryBySearch(country);
    return response;
  }
  ...
  Future getDeliveryRestrictedCountryList() async {
    ApiResponseModel apiResponse =
        await addressRepoInterface.getDeliveryRestrictedCountryList();
    return apiResponse;
  }
  ...
  Future getDeliveryRestrictedZipBySearch(String zipcode) async {
    ApiResponseModel response =
        await addressRepoInterface.getDeliveryRestrictedZipBySearch(zipcode);
    return response;
  }
  ...
  Future getDeliveryRestrictedZipList() async {
    ApiResponseModel apiResponse =
        await addressRepoInterface.getDeliveryRestrictedZipList();
    return apiResponse;
  }

  @override
  Future getShippingGovernorates() async {
    return addressRepoInterface.getShippingGovernorates();
  }
}
